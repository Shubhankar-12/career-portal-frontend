      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-16">
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-text-secondary max-w-2xl mx-auto">
            Create stunning, branded careers pages in minutes. Attract top
            talent with a professional online presence.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
          <div className="card">
            ...
            <p className="text-text-secondary">
              Intuitive interface to create sections and customize layouts
              without coding.
            </p>
          </div>
          <div className="card">
            ...
            <p className="text-text-secondary">
              Match your company colors and theme with our powerful color
              picker.
            </p>
          </div>
          <div className="card">
            ...
            <p className="text-text-secondary">
              Post, manage, and track open positions all in one place.
            </p>
          </div>
        </div>
      </main>
